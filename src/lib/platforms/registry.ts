...
export const PLATFORMS: PlatformConfig[] = [
  ...
  },
  {
    ...
    submitUrl: 'https://sell.g2.com/create-a-profile',
    category: 'review',
    automationLevel: 'semi',
  ...
  },
  {
    ...
    submitUrl: 'https://wellfound.com/onboarding/recruit',
    category: 'listing',
    automationLevel: 'manual',
  ...
  },
  {
    ...
    category: 'listing',
    automationLevel: 'full',
    description: 'Startup directory focused on new launches. Free submission.',
    loginRequired: false,
    hasCaptcha: false,
    requiresApproval: true,
    estimatedTime: 3,
    fields: [
      { name: 'Startup Name', selector: 'input[name="startupname"]', type: 'text', required: true, mapTo: 'name', maxLength: 100 },
      { name: 'URL', selector: 'input[name="startupurl"]', type: 'url', required: true, mapTo: 'url', maxLength: 100 },
      { name: 'Headline', selector: 'input[name="description"]', type: 'text', required: true, mapTo: 'tagline', maxLength: 100 },
      { name: 'Full Description', selector: 'textarea[name="fulldescription"]', type: 'textarea', required: true, mapTo: 'description' },
      { name: 'Tags', selector: 'textarea[name="tags"]', type: 'textarea', required: false, mapTo: 'keywords', maxLength: 500 },
    ],
  },
  {
    id: 'startup_ranking',
    ...
    submitUrl: 'https://www.startupranking.com/startup/new',
    category: 'listing',
    automationLevel: 'full',
  ...
  },
  {
    ...
    submitUrl: 'https://microlaunch.net/p/submit',
    category: 'directory',
    automationLevel: 'full',
